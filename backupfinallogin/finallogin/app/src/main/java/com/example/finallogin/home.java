...
//    String uid,name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstSlide.add(new Slide(R.drawable.paris,"Paris"));
        lstSlide.add(new Slide(R.drawable.venice,"Venice"));
        lstSlide.add(new Slide(R.drawable.rome,"Rome"));
        lstSlide.add(new Slide(R.drawable.mumbai,"Mumbai"));
...
//        id.setText(uid);
       ...
       // models = new ArrayList<>();
        ...
        models = new ArrayList<>();
        models.add(new Model(R.drawable.explore,"Explore"));
        models.add(new Model(R.drawable.places_around_2,"Places Around"));
        models.add(new Model(R.drawable.travel_planner_1,"Plan Travel"));
